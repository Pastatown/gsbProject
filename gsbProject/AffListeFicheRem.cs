...
{
    public partial class AffListeFicheRem : Form
    {
        public AffListeFicheRem()
        {
            InitializeComponent();
        }

        //affichage des fiches remboursées
        private void AffListeFicheRem_Load(object sender, EventArgs e)
        {
            MySqlDataAdapter msda = new MySqlDataAdapter("SELECT visiteur.NOM as 'v_nom', visiteur.PRENOM as 'v_prenom', fichedefrais.ID as 'fiche_id', fichedefrais.DATEDEBUT as 'f_date', etat.LIBELLE as 'e_libelle', CONCAT(visiteur.NOM, ' ', visiteur.PRENOM, ' - ', fichedefrais.DATEDEBUT) as 'v_all' FROM visiteur INNER JOIN fichedefrais ON visiteur.ID = fichedefrais.ID_POSSEDER INNER JOIN etat on fichedefrais.ID_ETRE_DE2 = etat.ID WHERE etat.LIBELLE = 'Remboursée' ORDER BY visiteur.NOM; ", Program.mydb.connection);


            DataSet DS = new DataSet();
            msda.Fill(DS);

            lboxLstFicheRem.DataSource = DS.Tables[0];  // lie le jeu de données à la combo
            lboxLstFicheRem.DisplayMember = "v_all"; // colonne de la table apparaissant dans la liste
            lboxLstFicheRem.ValueMember = "fiche_id";    // valeur retournée lorsqu'un élément est sélectionné
        ...
        private void lboxLstFicheRem_Click(object sender, EventArgs e)
        {
            MySqlCommand command1 = Program.mydb.connection.CreateCommand();
            command1.CommandText = "select QUANTITE from forfaitise where ID_COMPOSER = " + lboxLstFicheRem.SelectedValue + " and ID_ETRE_DE=1;";
            command1.Parameters.AddWithValue("@id", lboxLstFicheRem.SelectedValue.ToString());
            ...
            command2.CommandText = "select QUANTITE from forfaitise where ID_COMPOSER = " + lboxLstFicheRem.SelectedValue + "  and ID_ETRE_DE=2;";
            command2.Parameters.AddWithValue("@id", lboxLstFicheRem.SelectedValue.ToString());
            ...
            command3.CommandText = "select QUANTITE from forfaitise where ID_COMPOSER = " + lboxLstFicheRem.SelectedValue + "  and ID_ETRE_DE=3;";
            command3.Parameters.AddWithValue("@id", lboxLstFicheRem.SelectedValue.ToString());
            ...
            command4.CommandText = "select QUANTITE from forfaitise where ID_COMPOSER = " + lboxLstFicheRem.SelectedValue + "  and ID_ETRE_DE=4;";
            command4.Parameters.AddWithValue("@id", lboxLstFicheRem.SelectedValue.ToString());
            ...
            MySqlDataAdapter msda2 = new MySqlDataAdapter("select ID as 'h_id', LIBELLE as 'h_libelle' from horsforfait where ID_COMPOSER2= " + lboxLstFicheRem.SelectedValue + " ; ", Program.mydb.connection);
            ...
            try
            {
                ...
                "where fichedefrais.id = " + lboxLstFicheRem.SelectedValue + " ;";
                command5.Parameters.AddWithValue("@id", lboxLstFicheRem.SelectedValue.ToString());
            }
        ...
        private void lboxFHF_Click(object sender, EventArgs e)
        {
            ...
            command6.CommandText = "SELECT libelle, montant, date_format(date, '%d-%m-%Y') as 'date' from horsforfait where id_composer2 = " + lboxLstFicheRem.SelectedValue + " and ID = " + lboxFHF.SelectedValue + " ; ";
            ...
            command51.CommandText = "SELECT validation from horsforfait where id_composer2 = " + lboxLstFicheRem.SelectedValue + " and ID = " + lboxFHF.SelectedValue + " ; ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            MySqlDataAdapter msda3 = new MySqlDataAdapter("SELECT visiteur.NOM as 'v_nom', visiteur.PRENOM as 'v_prenom', fichedefrais.ID as 'fiche_id', fichedefrais.DATEDEBUT as 'f_date', etat.LIBELLE as 'e_libelle', " +
                ...
                "INNER JOIN etat on fichedefrais.ID_ETRE_DE2 = etat.ID WHERE etat.LIBELLE = 'Remboursée' and visiteur.ID = " + cboxName.SelectedValue + " ORDER BY fichedefrais.DATEDEBUT; ", Program.mydb.connection);

            DataSet DS3 = new DataSet();
            msda3.Fill(DS3);

            lboxLstFicheRem.DataSource = DS3.Tables[0];  // lie le jeu de données à la combo
            lboxLstFicheRem.DisplayMember = "v_all"; // colonne de la table apparaissant dans la liste
            lboxLstFicheRem.ValueMember = "fiche_id";    // valeur retournée lorsqu'un élément est sélectionné
        }
    }
